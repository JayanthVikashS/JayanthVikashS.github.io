...
const Footer = ({ name, showThemeLogo = true }) => (
  <footer className="bg-front mt-16 pt-8 pb-16">
    <div className="md:max-w-screen-sm lg:max-w-screen-xl mx-auto px-4 flex items-center">
      ...
      <br/>
      <center>
        <div className="w-2/3 text-back-light font-header text-xs" id="contact">Email - <a href="mailto:jayanth082001@gmail.com">jayanth082001@gmail.com</a><br/>Phone - <a href="tel:+919944487644">+919944487644</a></div>
      </center>
